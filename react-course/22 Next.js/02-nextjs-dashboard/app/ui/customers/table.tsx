...
import { ISearchCustomersResult } from '@/db/queries/generated/customers';

export default async function CustomersTable({ customers }: { customers: ISearchCustomersResult[] }) {
  return (
